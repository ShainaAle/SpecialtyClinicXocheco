...
$pageSubtitle = 'Controla el stock, la caducidad y el estado de los medicamentos.';
    ...
    <div class="col-lg-8">
        <div class="panel-card mb-4">
            <div class="panel-head">
                ...
                <p class="section-subtitle">Filtra por nombre o estado del inventario.</p>
            </div>
            <div class="panel-body">
                <form method="get" class="row g-2 align-items-end">
                    <div class="col-md-5">
                        <label class="form-label">Buscar</label>
                        <input type="text" name="q" class="form-control" value="<?php echo htmlspecialchars($search); ?>" placeholder="Medicamento, principio activo">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Estado</label>
        ...
        <div class="panel-card">
            <div class="panel-head">
                ...
                <p class="section-subtitle">Stock disponible por lote.</p>
            </div>
            <div class="panel-body">
                        ...
                        <tbody>
                            <?php foreach ($inventory as $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-soft" href="?<?php echo htmlspecialchars(http_build_query(array_merge($baseFilterParams, ['edit' => $item['id_lote']]))); ?>">Editar</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            <?php if (!$inventory): ?>
