            ...
            <div class="row mb-4">
                ...
                <div class="col-md-3 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?php echo $basePath; ?>/index.php">Inicio</a></li>
                        <li class="mb-2"><a href="<?php echo $basePath; ?>/index.php#servicios">Servicios</a></li>
                        <li class="mb-2"><a href="<?php echo $basePath; ?>/portal.php">Mi portal</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
